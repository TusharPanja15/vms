                                            ...
                                            <tbody>
                                                <form>
                                                    <tr data-bs-toggle="modal" data-bs-target="#saleModal">
                                                        ...
                                                        <td><input type="button" name="delete" value="delete" id="<?php echo $row["sales_id"] ?>" class="btn btn-danger btn-xs delete_data"></td>
                                                    </tr>
                                                </form>
                                            </tbody>
                                        <?php
                                            ...
                                            <form method="POST" action="" id="salesform" class="form">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" id="email" name="email" placeholder="Apartment, studio, or floor">
                                                    </div>
